	...
	<div class="contatin-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="edit_profile.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mr-5"><i
     		...
     		<div class="card">
                <img src="userqrcode/<?php echo $row['user_qrcode'] ?>" class="rounded mx-auto d-block" alt="user_qrcode">
                <h3 class="card-title text-center">Your QR Code</h3>
                <p class="text-center">Dowload QR this to show to librarian your request book/s</p>
     			<div class="card-body">
     				<ul>
     					...
     					<li>Email Address: <?php echo $row['email']?></li>
                                        ...
                                        <li>Profession: <?php echo $row['user_type']?></li>
     				</ul>
     			</div>
     		</div>
	</div>
