...
if ($old_pass != $password) {
    ...
    echo "<script>alert('New Password do not match to Confirm Password!'); window.location='edit_pass.php'</script>";
        ...
        mysqli_query($con," UPDATE admin SET username='$username', password='$new_password', 
        confirm_password='$confirm_password' WHERE admin_id = '$id_session' ")or die(mysqli_error());
